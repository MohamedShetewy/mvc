    ...
    <div class="container">
        ...
        <div class="row">
            <div  class="form-floating col-md-6 st-br">
                ...
                <input required type="text" class="form-control" name="PrivilegeTitle" id="PrivilegeTitle" value="<?=$privilege->PrivilegeTitle?>" maxlength="30"  >
                <label for="PrivilegeTitle"> <?=$text_lable_privilege_tilte?> </label>
            </div>

            <div class="form-floating col-md-6 st-br">
                <input required type="text" class="form-control" name="Privilege" id="Privilege" value="<?=$privilege->Privilege?>" maxlength="30" >
